...
public class Main {
    public static void main(String[] args) {
        ...
        // Funcao map
        // Aplicada sobre uma metodo estatico
        ...
        List<String> names = listProduct.stream().map(Product::staticUpperCase).collect(Collectors.toList()); // converte para stream e depois chama a funcao map
